...
export const projects = [
  {
    ...
    githubUrl: 'https://github.com/sumitkumawat161-sketch/CareerSync-AI-Career-Assistant',
  ...
  },
  {
    ...
    tags: ['Python', 'PyTorch', 'Deep Learning', 'Signal Processing','STFT','ISTFT'],
    githubUrl: 'https://github.com/sumitkumawat161-sketch/Speech-Enhancement-Using-Deep-Learning-U-NET-',
    liveUrl: '',
    featured: false,
  },
  {
  ...
  },
  {
    ...
    tags: ['C++', 'OOPS','OS', 'Multithreading', 'STL','DSA','SQLITE'],
    githubUrl: 'https://github.com/sumitkumawat161-sketch/air-traffic-control-simulator',
    liveUrl: '',
    featured: false,
  },
]
